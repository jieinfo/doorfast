...
TEST_SOURCES := tests/test_main.c tests/test_config.c tests/test_sip.c tests/test_gvs_frame.c tests/test_gvs_session.c tests/test_policy.c tests/test_capture.c tests/test_audit.c tests/test_discovery.c tests/test_diagnostics.c src/config.c src/event.c src/sip.c src/gvs_frame.c src/gvs_session.c src/session.c src/policy.c src/capture.c src/audit.c src/discovery.c src/diagnostics.c
DAEMON_SOURCES := src/main.c src/config.c src/event.c src/sip.c src/gvs_frame.c src/gvs_session.c src/session.c src/policy.c src/capture.c src/audit.c src/discovery.c src/diagnostics.c
