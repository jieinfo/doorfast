...
int main(int argc, char **argv) {
    ...
    test_media_session_manager_cleans_busy_preview_after_three_rejections();
    test_media_session_manager_acknowledges_short_preview_and_retries();
    test_media_session_manager_acknowledges_peer_hangup_during_stop();
    ...
    test_media_session_manager_correlates_stop_ack_and_keeps_preview_retrying();
    test_media_session_manager_retries_stalled_video_session();
    ...
    test_gvs_monitor_retries_end_notification_without_reply();
    test_gvs_monitor_end_notification_retries_without_accepting_stale_video();
    test_gvs_monitor_end_notification_during_stop_does_not_reply_or_revive();
    ...
    test_gvs_media_receiver_reserves_burst_safe_receive_buffer();
